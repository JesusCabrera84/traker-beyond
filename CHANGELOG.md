...
- Cada celda lleva una figura dibujada en SVG que no representa la cosa sino el CAMBIO DE ESTADO que la capacidad produce: una placa extraída de una pila, una retícula vieja redibujada un nivel arriba, puntos dispersos resueltos en un trazo, anillos que decrecen vistos desde el dispositivo, máquinas distintas sobre una sola barra de medición, y cinco placas atravesadas por un hilo sin cortes. Unos 6 KB de vector, ninguna imagen nueva
