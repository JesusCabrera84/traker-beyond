...
The project is growing in modules (auth, billing, control panel) and engineering practices (CI, hooks, release discipline). We need a lightweight way to document significant technical decisions without heavy process.
